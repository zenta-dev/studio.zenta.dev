    ...
    versions: [
      {
        ...
        whatNews:
          "Lambda expressions, Method references, Optional class, Stream API, Date and Time API, Nashorn JavaScript Engine, Base64 Encode Decode, Default Methods, Type Annotations, etc.",
        hash: "java8",
      },
      {
        version: 11,
        ...
        whatNews:
          "Nest-Based Access Control, Dynamic Class-File Constants, Epsilon: A No-Op Garbage Collector, ZGC: A Scalable Low-Latency Garbage Collector, Local-Variable Syntax for Lambda Parameters, HTTP Client (Standard), Flight Recorder, Launch Single-File Source-Code Programs, etc.",
        hash: "java11",
      },
      {
        version: 17,
        ...
        whatNews:
          "Sealed classes, Pattern matching for switch, Records, Text blocks, Local-Variable Type Inference, Epsilon: A No-Op Garbage Collector, ZGC: A Scalable Low-Latency Garbage Collector, Local-Variable Syntax for Lambda Parameters, HTTP Client (Standard), Flight Recorder, Launch Single-File Source-Code Programs, etc.",
        hash: "java17",
      },
    ],
  },
  // python founder
  {
    ...
    versions: [
      ...
      },
      {
        ...
        whatNews:
          "New parser, New syntax features, New library modules, New built-in features, etc.",
        hash: "python39",
      },
    ],
  },
  // javascript founder
  {
    ...
    versions: [
      ...
      },
      {
        ...
        whatNews:
          "Async Functions, Shared Memory and Atomics, Object.values/Object.entries, String padding, Object.getOwnPropertyDescriptors, Trailing commas in function parameter lists and calls, etc.",
        hash: "es8",
      },
    ],
  },
    ...
    versions: [
      {
        ...
        whatNews:
          "TypeScript 1.0 introduces the ability to use classes and modules in your code.",
        hash: "ts1",
      },
      {
        version: 4,
        ...
        url: "https://en.wikipedia.org/wiki/TypeScript#History",
        whatNews:
          "Variadic Tuple Types, Labeled Tuple Elements, Class Property Inference from Constructors, Short-Circuiting Assignment Operators, Custom JSX Factories, etc.",
        hash: "ts4",
      },
      {
        version: 4.4,
        ...
        url: "https://en.wikipedia.org/wiki/TypeScript#History",
        whatNews:
          "Control Flow Analysis of Aliased Conditions, Symbol and Template String Pattern Index Signatures, etc.",
        hash: "ts44",
      },
    ],
  },
  // c founder
  {
    ...
    versions: [
      ...
      },
      {
        ...
        whatNews:
          "C99 added several new features to the C language, such as inline functions, several new data types, variable length arrays, flexible array members, and improved support for IEEE 754 floating point.",
        hash: "c99",
      },
      {
        version: 11,
        ...
        whatNews:
          "C11 added a standard Boolean data type, _Generic keyword, and improved Unicode support.",
        hash: "c11",
      },
    ],
  },
  // c++ founder
  {
    ...
    versions: [
      ...
      },
      {
        ...
        whatNews:
          "C++11 added several new features to the C++ language, such as auto keyword, nullptr, range-based for loop, lambda expressions, etc.",
        hash: "cpp11",
      },
      {
        version: 17,
        ...
        whatNews:
          "C++17 added several new features to the C++ language, such as inline variables, fold expressions, constexpr if, etc.",
        hash: "cpp17",
      },
    ],
  },
    ...
    versions: [
      {
        ...
        whatNews:
          "Kotlin 1.0 was the first stable version of Kotlin programming language.",
        hash: "kotlin1",
      },
      {
        version: 1.4,
        ...
        url: "https://en.wikipedia.org/wiki/Kotlin_(programming_language)#History",
        whatNews:
          "Kotlin 1.4 added several new features to the Kotlin language, such as SAM conversions for Kotlin interfaces, JVM records, etc.",
        hash: "kotlin4",
      },
      {
        version: 1.5,
        ...
        url: "https://en.wikipedia.org/wiki/Kotlin_(programming_language)#History",
        whatNews:
          "Kotlin 1.5 added several new features to the Kotlin language, such as JVM IR backend, Inline classes, etc.",
        hash: "kotlin5",
      },
    ],
  },
    ...
    versions: [
      {
        ...
        whatNews:
          "Dart 1.0 was the first stable version of Dart programming language.",
        hash: "dart1",
      },
      {
        version: 2.0,
        ...
        url: "https://en.wikipedia.org/wiki/Dart_(programming_language)#History",
        whatNews:
          "Dart 2.0 added several new features to the Dart language, such as Strong mode, Dart DevTools, etc.",
        hash: "dart2",
      },
      {
        version: 2.14,
        ...
        url: "https://en.wikipedia.org/wiki/Dart_(programming_language)#History",
        whatNews:
          "Dart 2.14 added several new features to the Dart language, such as Null safety, etc.",
        hash: "dart14",
      },
    ],
  },
    ...
    versions: [
      {
        ...
        whatNews:
          "Go 1.0 was the first stable version of Go programming language.",
        hash: "go1",
      },
      {
        version: 1.13,
        ...
        url: "https://en.wikipedia.org/wiki/Go_(programming_language)#History",
        whatNews:
          "Go 1.13 added several new features to the Go language, such as Error wrapping, Number literal syntax, etc.",
        hash: "go13",
      },
      {
        version: 1.17,
        ...
        url: "https://en.wikipedia.org/wiki/Go_(programming_language)#History",
        whatNews:
          "Go 1.17 added several new features to the Go language, such as Generics, Error values, Embedding of interfaces, etc.",
        hash: "go17",
      },
    ],
  },
    ...
    versions: [
      {
        ...
        whatNews:
          "Rust 1.0 was the first stable version of Rust programming language.",
        hash: "rust1",
      },
      {
        version: 1.5,
        ...
        url: "https://en.wikipedia.org/wiki/Rust_(programming_language)#History",
        whatNews:
          "Rust 1.50 added several new features to the Rust language, such as const generics, etc.",
        hash: "rust50",
      },
      {
        version: 1.55,
        ...
        url: "https://en.wikipedia.org/wiki/Rust_(programming_language)#History",
        whatNews:
          "Rust 1.55 added several new features to the Rust language, such as const generics, etc.",
        hash: "rust55",
      },
    ],
  },
    ...
    versions: [
      {
        ...
        whatNews:
          "PHP 3 was the first stable version of PHP programming language.",
        hash: "php3",
      },
      {
        version: 5,
        ...
        url: "https://en.wikipedia.org/wiki/PHP#History",
        whatNews:
          "PHP 5 added several new features to the PHP language, such as Object-oriented programming, etc.",
        hash: "php5",
      },
      {
        version: 8,
        ...
        url: "https://en.wikipedia.org/wiki/PHP#History",
        whatNews:
          "PHP 8 added several new features to the PHP language, such as Union Types, Named Arguments, Match Expressions, Attributes, Constructor Property Promotion, etc.",
        hash: "php8",
      },
    ],
  },
...
const tags = [
  ...
  },
  {
    ...
    photo:
      "https://saigontechnology.com/assets/media/Blog/typical-process-for-a-successful-mobile-development.jpeg",
  },
  {
    ...
    photo:
      "https://media.istockphoto.com/id/1310129219/id/foto/komputasi-awan-pusat-data-rak-server-koneksi-dalam-jaringan-saraf-teknologi.jpg?s=612x612&w=0&k=20&c=DY2KY0odTFlnHcFROTlNI46BAesQ-5VyUH0alKeCFZ8=",
  },
  {
    name: "Cyber Security",
    description:
    ...
    photo:
      "https://media.istockphoto.com/id/1412282189/id/foto/kunci-konsep-teknologi-jaringan.jpg?s=612x612&w=0&k=20&c=Pa3vJHisjpY-g_n69UJqnfciZKSVHk-2ZYERHAWdBrE=",
  },
  {
    name: "DevOps",
    description:
    ...
    photo:
      "https://media.istockphoto.com/id/1309642115/id/foto/konsep-devops.jpg?s=612x612&w=0&k=20&c=TFxYmsEVtXJcsACyYRISngw2dAcqk8HLqgcmjnkHnwk=",
  },
  {
